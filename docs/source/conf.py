...
# -*- coding: utf-8 -*-
#
# ipyuploader documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipyuploader', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipyuploaderdoc'
...
latex_documents = [
    (master_doc, 'ipyuploader.tex', 'ipyuploader Documentation',
     'FW', 'manual'),
]
